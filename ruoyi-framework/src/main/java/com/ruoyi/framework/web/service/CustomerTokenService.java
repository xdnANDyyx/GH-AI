...
public class CustomerTokenService {
    ...
    @Value("${token.customer-default-token:}")
    private String customerDefaultToken;
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            try {
                ...
                log.error("获取客户用户信息异常'{}'", e.getMessage());
            }
        }
        return null;
    }
    ...
    private String getTokenKey(String uuid) {
        return CacheConstants.CUSTOMER_LOGIN_TOKEN_KEY + uuid;
    }
}
