...
public class PermissionService {
    private boolean isAdminAccount(LoginUser loginUser) {
        if (loginUser == null || loginUser.getUser() == null) {
            return false;
        }
        if ("admin".equalsIgnoreCase(loginUser.getUser().getUserName())) {
            return true;
        }
        if (UserType.ADMIN.getCode().equals(loginUser.getUser().getUserType())) {
            return true;
        }
